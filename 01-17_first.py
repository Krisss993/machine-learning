...
# przypisanie wartosci 1,2,3 do nazw
...
#NOWE DANE OPISUJACE KWIATY IRIS
...
# przypisanie nazw do przewidzianych danych
...
# wybranie kolumny mpg jako zmienna docelowa
y = mpg.loc[:, 'mpg']
y.head()


# dopasowanie modelu oraz jego ocena
lr = LinearRegression()
lr.fit(X.to_numpy(), y)
